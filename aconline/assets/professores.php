	...
	<html lang="pt-BR">
		...
		<body>
				...
				<nav class="verdeIF">
					<div class="nav-wrapper black-text">
						<ul id="menu" class="sidenav">
							...
							<li style="background-color: rgba(0, 0, 0, 0.1);"><a href="#!" style="color: #349A47"><i class="material-icons" style="color: #349A47">format_align_justify</i>Professores</a></li>
						...
						<ul class="brand-logo right">
							<li><a href="cadastroProfessor.php" class="center"><i class="material-icons icone center">add_circle</i></a></li>
						</ul>
			...
			<main>
				...
				<h4 class="texto center" style="color: #349A47">Professores</h4>
					<div class="row black-text center" style="margin-top: 5vh">
						<?php
							Professores();
						?>
						<div class="col s12 l4">
							<a href="cadastroProfessor.php" class="center">
