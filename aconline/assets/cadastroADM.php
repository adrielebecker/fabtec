...
<!DOCTYPE html>
	<html lang="pt-BR">
		<head>
			...
			<!-- Título -->
			<title>ADM | <?php echo $vetor[8]; ?> Administrador</title>
		</head>
		<body>
			<header>
				<nav class="verdeIF">
					<div class="nav-wrapper black-text">
						...
						<ul class="brand-logo right hide-on-small-only">
							<li><a href="administradores.php" class="center">Administradores</a></li>
						</ul>
			...
			<form action="acao.php" method="post" enctype="multipart/form-data">
				<div class="container center">
					<h3 class="texto verdeIFtexto"><?php echo $vetor[8]; ?> Administrador</h3>
					<div class="row">
					...
					<div class="col s10 offset-s3">
							<?php
								if ($vetor[7] == 'alterar') {
							?>
							<button class="waves-effect waves-light btn verdeIF white-text" type="submit" value="alterarOcupacao.2" name="acao">
								Tornar Professor
							</button>
							<button class="waves-effect waves-light btn verdeIF white-text" type="submit" value="alterarOcupacao.4" name="acao">
								Tornar Técnico Adminstrativo
							</button>
							<?php
								}
							?>
				...
				<input type="hidden" name="pagina" value="administradores.php">
