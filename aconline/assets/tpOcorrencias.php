...
<!DOCTYPE html>
	<html lang="pt-BR">
		<head>
			...
			<!-- Título -->
			<title>ADM | Tipo de Ocorrência</title>
		...
		<body>
				...
				<nav class="verdeIF">
					<div class="nav-wrapper black-text">
						<ul id="menu" class="sidenav">
							...
							<li style="background-color: rgba(0, 0, 0, 0.1);"><a href="../assets/tpOcorrencias.php" style="color: #349A47"><i class="material-icons" style="color: #349A47">list</i>Tipo de Ocorrência</a></li>
			...
			<main>
				...
				<h4 class="texto center" style="color: #349A47">Tipo de Ocorrência</h4>
								...
								<div class="card-panel hoverable valign-wrapper center" style="width:100%; background: #349A47">
									<div class="row center" style="width:100%">
										<div class="col s12 center" style="color: #FFF">
											...
											<h5>Adicionar Tipo de Ocorrência</h5>
										</div>
									</div>
								</div>
							</a>
					...
					<div class="modal-content">
						<fieldset style="border: none;">
							<form action="acaoLogin.php" method="post">
								<h4 class="verdeIFtexto">Adicionar Tipo de Ocorrência</h4>
								<div class="row">
								...
								<div class="row">		
									<div class="col s8 offset-s2 white-text">
										<input type="hidden" name="acao" value="adicionar_tpOcorrencia">
