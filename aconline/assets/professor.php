...
<!DOCTYPE html>
  <html lang="pt-br">
    ...
    <body class="profile-page sidebar-collapse">
        ...
        <div class="container">
          <div class="dropdown button-dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item" href="#turmas">Turmas</a>
            </div>
          </div>
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="../assets/img/blurred-image-1.jpg">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link" rel="tooltip" title="Ocorrências" data-placement="bottom" href="ocorrencia.php">
					<i class="material-icons">gavel</i>
					<p class="d-lg-none d-xl-none">Ocorrências</p>
				</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" rel="tooltip" title="Editar Perfil" data-placement="bottom" href="editarPerfil.php">
      ...
      <!-- End Navbar -->
      <div class="wrapper">
        <?php PerfilProfessor($_SESSION['codigo'])?>
          </div>
