	...
	<html lang="pt-BR">
		...
		<body>
				...
				<nav class="verdeIF">
					<div class="nav-wrapper black-text">
						<ul id="menu" class="sidenav">
							...
							<li style="background-color: rgba(0, 0, 0, 0.1);"><a href="../assets/turmas.php" style="color: #349A47"><i class="material-icons" style="color: #349A47">people</i>Turmas</a></li>
			...
			<main>
				...
				<h4 class="texto center" style="color: #349A47">Turmas</h4>
					...
					<div class="modal-content">
						<fieldset style="border: none;">
							<form action="acaoLogin.php" method="post">
								<h4 class="verdeIFtexto">Adicionar Turma</h4>
								<div class="row">
									<div class="input-field col s6 offset-s3">
										<select name="ano" id="ano">
											<option value="" disabled selected>Ano</option>
											<option class="verdeIFtexto" value="1">1º</option>
											<option class="verdeIFtexto" value="2">2º</option>
											<option class="verdeIFtexto" value="3">3º</option>
										</select>
									</div>
									<div class="input-field col s6 offset-s3">
										<?php 
											geraSelect('Curso', 'curso', 0, 0, 'nome', 'curso');
										?>
									</div>
								</div>
								<div class="row">		
