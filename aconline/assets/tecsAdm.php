	...
	<html lang="pt-BR">
		...
		<body>
				...
				<nav class="verdeIF">
					<div class="nav-wrapper black-text">
						<ul id="menu" class="sidenav">
							...
							<li style="background-color: rgba(0, 0, 0, 0.1);"><a href="../assets/tecsAdm.php" style="color: #349A47"><i class="material-icons" style="color: #349A47">folder</i>Técnico Administrativo</a></li>
						...
						<ul class="brand-logo right">
							<li><a href="cadastroTecAdm.php" class="center"><i class="material-icons icone center">add_circle</i></a></li>
						</ul>
			...
			<main>
				...
				<h4 class="texto center" style="color: #349A47">Técnicos Administrativos</h4>
					<div class="row black-text center" style="margin-top: 5vh">
						<?php
							TecsAdm();
						?>
						<div class="col s12 l4">
							<a href="cadastroTecAdm.php" class="center">
								<div class="card-panel hoverable valign-wrapper center" style="width:100%; background: #349A47">
									<div class="row center" style="width:100%">
										<div class="col s12 center" style="color: #FFF">
											...
											<h5>Adicionar Técnico Administrativo</h5>
										</div>
									</div>
								</div>
							</a>
				...
				<div class="modal-content">
					<fieldset style="border: none;">
						<form action="acaoLogin.php" method="post">
							<h4 class="blue-text">Adicionar Turma</h4>
							<div class="row">
								<div class="col s6 offset-s3">
									<label for="nome_disciplina">Nome da Turma</label>
									<input type="text" name="nome_turma">
								</div>		
								<div class="col s8 offset-s2 white-text">
									<input type="hidden" name="acao" value="adicionar_servidores">
