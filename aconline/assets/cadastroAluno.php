...
<!DOCTYPE html>
	<html lang="pt-BR">
		<head>
			...
			<!-- Título -->
			<title>ADM | <?php echo $vetor[8]; ?> Aluno</title>
		</head>
		<body>
			<header>
				<nav class="verdeIF">
					<div class="nav-wrapper black-text">
						...
						<ul class="brand-logo right hide-on-small-only">
							<li><a href="alunos.php" class="center">Alunos</a></li>
						</ul>
			...
			<div class="container center">
				<h3 class="texto verdeIFtexto"><?php echo $vetor[8]; ?> Aluno</h3>
				<?php 
				...
				<form action="acao.php" method="post" enctype="multipart/form-data">
					<div class="row">
						...
						<div class="input-field col l4 m6 s12">
							...
							<input id="password" type="password" class="validate" name="senha" value="" <?php if($vetor[7] == 'cadastrar') echo "required"; ?>>
						...
						<div class="input-field col s12 l4">
							<?php 
								if ($vetor[7] == 'cadastrar') {
									geraSelectTurma("Turma", "turma", 0, 0, "ano", "turma");
								}
								else{
									geraSelectTurma("Turma", "turma", $vetor[10], 0, "ano", "turma");
								}
							?>
						</div>
						...
						<div class="input-field col l6 offset-l3 m6 s12">
							...
							<input type="hidden" name="pagina" value="alunos.php">
							<input type="hidden" name="tabela" value="usuario">
							<input type="hidden" name="ocupacao" value=3>
						</div>
					</div>
				</form>
			</div>
