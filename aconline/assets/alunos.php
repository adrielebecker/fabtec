	...
	<html lang="pt-BR">
		...
		<body>
				...
				<nav class="verdeIF">
					<div class="nav-wrapper black-text">
						<ul id="menu" class="sidenav">
							...
							<li style="background-color: rgba(0, 0, 0, 0.1);"><a href="../assets/alunos.php" style="color: #349A47"><i class="material-icons" style="color: #349A47">check_circle</i>Alunos</a></li>
						...
						<ul class="brand-logo right">
							<li><a href="cadastroAluno.php" class="center"><i class="material-icons icone center">add_circle</i></a></li>
						</ul>
			...
			<main>
				...
				<h4 class="texto center" style="color: #349A47">Alunos</h4>
					<div class="row black-text center" style="margin-top: 5vh">
						<?php
							Alunos();	
						?>
						<div class="col s12 l4">
							<a href="cadastroAluno.php" class="center">
								<div class="card-panel hoverable valign-wrapper center" style="width:100%; padding: 3em; background: #349A47">
